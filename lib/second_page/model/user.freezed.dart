...
class _$_User implements _User {
  const _$_User(this.id, this.name, this.username, this.email, this.address,
...
abstract class _User implements User {
  const factory _User(int id, String name, String username, String email,
      Address address, String phone, String website, Company company) = _$_User;
...
class _$AddressTearOff {
  ...
  _Address call(
      String street, String suite, String city, Geo geo, String zipcode) {
    return _Address(
      street,
      suite,
      city,
...
class _$_Address implements _Address {
  const _$_Address(this.street, this.suite, this.city, this.geo, this.zipcode);
  ...
  @override
  String toString() {
    return 'Address(street: $street, suite: $suite, city: $city, geo: $geo, zipcode: $zipcode)';
  }
