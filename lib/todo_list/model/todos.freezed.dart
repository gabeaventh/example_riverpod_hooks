...
abstract class _Todos implements Todos {
  factory _Todos(List<Todo> todos) = _$_Todos;
...
class _$TodoTearOff {
  ...
  _Todo call({int? userId, int? id, String? title, bool? completed}) {
    return _Todo(
      userId: userId,
      id: id,
      title: title,
...
class _$_Todo implements _Todo {
  _$_Todo({this.userId, this.id, this.title, this.completed});
...
abstract class _Todo implements Todo {
  factory _Todo({int? userId, int? id, String? title, bool? completed}) =
      _$_Todo;
